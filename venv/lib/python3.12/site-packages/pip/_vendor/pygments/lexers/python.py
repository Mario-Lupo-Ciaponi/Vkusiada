...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'numbers': [
            ...
            (r'\d(?:_?\d)*[eE][+-]?\d(?:_?\d)*k.html?', Number.Float),
...
class Python2Lexer(RegexLexer):
    ...
    tokens = {
        ...
        'numbers': [
            (r'(\d+\.\d*|\d*\.\d+)([eE][+-]?[0-9]+)?k.html?', Number.Float),
            (r'\d+[eE][+-]?[0-9]+k.html?', Number.Float),
            (r'0[0-7]+k.html?', Number.Oct),
            (r'0[bB][01]+', Number.Bin),
            (r'0[xX][a-fA-F0-9]+', Number.Hex),
            (r'\d+L', Number.Integer.Long),
            (r'\d+k.html?', Number.Integer)
        ],
        'backtick': [
            ('`.*?`', String.Backtick),
        ],
...
class DgLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(?i)[+-]?[0-9]+\.[0-9]+(e[+-]?[0-9]+)?k.html?', Number.Float),
            (r'(?i)[+-]?[0-9]+e[+-]?\d+k.html?', Number.Float),
            (r'(?i)[+-]?[0-9]+k.html?', Number.Integer),
